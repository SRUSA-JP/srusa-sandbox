...
export const HOME_UPDATES: HomeUpdate[] = [
  {
    date: '2026-09-16',
    category: '年表',
    title: 'オフラインカスタムのもう1回ぶんの年月が判明',
    href: '#/history',
    summary: 'オフラインカスタムのもう 1 回ぶんが 2025-08-30 開催と分かりました。配信アーカイブも 2 本残っています。',
    details: [
      '「オフラインカスタム」の未記入ぶんの年月を 2025-08-30 に更新',
      '配信アーカイブが 2 本残っていることを追記',
      '参加者はまだ分かっていないため、引き続き「これから埋めること」に残す',
    ],
  },
  {
    date: '2026-09-16',
  ...
  },
  {
    ...
    title: 'ギャラリーのタグを色分け',
    href: '#/gallery',
    summary: 'ゲーム・登場人物・シーンのタグの枠線・文字の色を分け、見分けやすくしました。押して絞り込む操作は今までどおりです。',
    details: [
      'タグの枠線・文字の色をゲーム / 登場人物 / シーンの種類ごとに分けた',
      '絞り込んでも種類ごとの色は変わらない',
    ],
  },
  {
