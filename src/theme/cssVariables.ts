...
export function themeCssVariables(theme: VizTheme): Record<string, string> {
  const variables: Record<string, string> = {
    ...
    [cssVar('viz-surface-sunken')]: theme.surfaceSunken,
    [cssVar('viz-surface-hover')]: theme.surfaceHover,
    [cssVar('viz-surface-overlay')]: theme.surfaceOverlay,
    [cssVar('viz-border')]: theme.border,
    [cssVar('viz-border-strong')]: theme.borderStrong,
    [cssVar('viz-text-primary')]: theme.textPrimary,
    [cssVar('viz-text-secondary')]: theme.textSecondary,
    [cssVar('viz-text-tertiary')]: theme.textTertiary,
    [cssVar('viz-accent')]: theme.accent,
    [cssVar('viz-accent-hover')]: theme.accentHover,
    [cssVar('viz-accent-subtle')]: theme.accentSubtle,
