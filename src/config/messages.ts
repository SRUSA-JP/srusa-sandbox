...
export const APP_TEXT = {
  ...
  shortName: 'SRUSA',
  /** サイト名の下に出す説明。 */
  siteNote: 'SRUSA の試験用コンテンツを公開している場所です。Minecraft サーバーの統計、ワールドマップ、相関図、SRUSA 図鑑があります。',
  /**
   * 検索結果やホーム画面に出る説明。
   * 画面に出る siteNote と役割が違う（こちらは中身を見ずに読まれる）ので別に持つ。
   */
  siteDescription:
    'SRUSA の試験用コンテンツを公開しているサイトです。Minecraft サーバーの統計、ワールドマップ、相関図、SRUSA 図鑑を置いています。掲載内容と公開範囲は検討中です。',
  /** タブ全体の読み上げ名。 */
  navLabel: 'ページ',
